...
export function subscribeToHabits(userId, onChange, onError) {
...
export function subscribeToCheckIns(habitId, onChange, onError) {
...
export async function createHabit(userId, { name, description, icon, color, frequency }) {
...
/** Toggles today's (or a given) check-in on/off for a habit. */
export async function toggleCheckIn(habitId, dateKey = todayKey()) {
